...
\begin{enumerate}[label=\alph*)]
	...
	% $ 0.4 ns *(150'000 * 1.8) = 10'800 ns = 1.08 * 10^{-4} s$
...
\begin{enumerate}[label=\alph*)]
	...
	%TODO Annahme wir setzen für die Zykluszeit die effektive Zeit der Ausführung eines Zykluses ein: 1/180000000 s = 5.555555556e-09s -> 5.555556 ns
	% 	t = (5 + 5 - 1) * 5.555556 ns = 50.0004 ns
	% -> Die neue Zykluszeit beträgt so: 50 ns
	...
	%TODO Sollte der Prozess nicht in mehrere kleinere Stufen aufgeteilt werden (also nicht in weniger Stufen). So können mehrere kurze Befehle gleichzeitig ausgeführt werden. -
...
%	\begin{tabular}{ l l l l l l l }
%		Prozessornummer & Intel® Core™ i7-4960HQ Processor (6M Cache, up to 3.70 GHz)\\
%		Cache & 6.0 MB\\
