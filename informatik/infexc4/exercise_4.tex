...
\begin{enumerate}[label=\alph*)]
	\item
		...
		\begin{itemize}
			...
			\item \textit{DRAM (Arbeitsspeicher)}:  %TODO: DBRU: \url{http://www.kingston.com/datasheets/KHX24C11T3K4_32X.pdf}
		...
		% 	Es wird nach Vor/Nachteil gefragt, aber konnte keine Nachteil von ddr finden... Weist du was?
