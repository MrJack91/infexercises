...
\begin{enumerate}[label=\alph*)]
	...
	$ (1 / 1.25 GHz)*(150'000 * 1.45) = 1.7400 * 10^{-4} s$
	\item
	\textit{Wieso ist der berechnete Wert nur ein Näherungswert? Lösung: (2 Punkte)}\\
	Da Der CPI-Wert "nur" der Durchschnitt ist, wird je nach tatsächlich ausgeführten Befehlen eine andere Ausführungszeit erreicht. (z.B. Nur Befehle welche mehrere Zyklen zur Ausführung verwenden, oder nur Befehle die einen Zyklus brauchen) 
	\item
