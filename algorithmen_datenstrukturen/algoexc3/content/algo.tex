...
%TODO: Chömmer echt d Site "`länger"' mache? Une hets immer zimmli vill Leerflächi... fühle dich frei... :s i has probiert, aber nid usegfunge...
...
%TODO mha: genügt es da nicht, in jedem Case die Laufzeit als $O(n-x)$ anzugeben?
%TODO dbru: Weisses ned, im Script han i das mit dene 3 Cases gfunde...
...
%TODO mha: wenn x=0, dann haben wir eine Endlosschleife. Auch das x-Fache von 0 ist 0. Die x. Hälfte einer Zahl wird nie null sein. Wie kommst du auf log()? - Was passiert eigentlich mit negativen Zahlen?
%TODO: hmm...stimmt, habe mal Beispiele für Laufzeiten gegoogelt, irgendwie bin ich dann auf log(n) gekommen...weiss leider die Seite nicht mehr :-(
